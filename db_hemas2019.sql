...
CREATE TABLE `tbl_newspaper_booking` (
  ...
  `np_pay_status` int(11) NOT NULL,
  `np_book_status` tinyint(11) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `tbl_np_booking_pay` (
  ...
  `pay_time` time NOT NULL,
  `pay_status` tinyint(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `tbl_newspaper_booking`
  MODIFY `np_book_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
